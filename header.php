...
$category=[];
//$category=array();
$cat_res=mysqli_query($con,"select * from category where status=1");
                                ...
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        ...
                                        <li class="drop"><a href="#">Category</a>
                                            <ul class="dropdown">
                                                <!-- Start Single dropdown || mega_dropdown  -->
                                                <li>
                                                    <ul class="mega__item">
                                                      <?php foreach ($category as $cat_list) {
                                                      echo "  <li><a href='category.php?id=".$cat_list['cat_id']."'>".$cat_list['cat_name']."</a></li> ";
                                                      }?>
                                                    </ul>
                                                </li>
                                                <!-- End Single drop down -->
                                            </ul>
                                        </li>
