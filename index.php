                ...
                <div class="htc__product__container">
                    <div class="row">
                        <div class="product__list clearfix mt--30">
                            ...
                            <?php
                                  $product=get_product($con,'latest',8);
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.php?id=<?php echo $product['pro_id'];?>">
                                            <img src="<?php echo images_site.''.$product['pro_image']; ?>" alt="product images">
                                        </a>
                                    </div>
                                    ...
                                    <div class="fr__product__inner">
                                        <h4><a href="product-details.php?id=<?php echo $product['pro_id'];?>"><?php echo $product['pro_name']; ?></a></h4>
                                        <ul class="fr__pro__prize">
                                            <li class="old__prize"><?php echo $product['pro_mrp']; ?></li>
                                            <li><?php echo $product['pro_price']; ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
